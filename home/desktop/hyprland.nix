...

{
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      workspace = 1, monitor:DP-1, monitor:eDP
      workspace = 2, monitor:DP-1, monitor:eDP
      workspace = 3, monitor:DP-1, monitor:eDP
      workspace = 4, monitor:DP-1, monitor:eDP
      workspace = 5, monitor:DP-1, monitor:eDP
      workspace = 6, monitor:HDMI-A-1, monitor:eDP
      workspace = 7, monitor:HDMI-A-1, monitor:eDP
      workspace = 8, monitor:HDMI-A-1, monitor:eDP
      workspace = 9, monitor:HDMI-A-1, monitor:eDP
      workspace = 10, monitor:HDMI-A-1, monitor:eDP
    '';
  };
}
